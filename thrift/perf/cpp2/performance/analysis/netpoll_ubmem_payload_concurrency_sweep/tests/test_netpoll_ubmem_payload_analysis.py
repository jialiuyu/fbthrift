...
def test_derived_metrics_capture_peak_retention_and_concurrency_cost() -> None:
    ...
    assert c128_zero.tps_gain_vs_previous_concurrency_pct == pytest.approx(1.14, abs=0.01)
    assert c128_zero.tp99_change_vs_previous_concurrency_pct == pytest.approx(120.0, abs=0.01)
    assert c64_3350.tps_retention_vs_zero_payload_pct == pytest.approx(72.89, abs=0.01)
